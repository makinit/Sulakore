...
namespace Sulakore.Communication
{
    public class CertificateManager : IDisposable
    {
        private const string CERT_CREATE_FORMAT =
            "-ss {0} -n \"CN={1}, O={2}\" -sky {3} -cy {4} -m 120 -a sha256 -eku 1.3.6.1.5.5.7.3.1 -b {5} {6}";
        ...
        protected virtual string GetCertificateCreateArgs(X509Store store, string certificateName)
        {
            ...
            string certCreatArgs = string.Format(CERT_CREATE_FORMAT,
                ...
                isRootCertificate ? "authority" : "end", DateTime.Now.ToString("MM/dd/yyyy", CultureInfo.GetCultureInfo("en-US")),
