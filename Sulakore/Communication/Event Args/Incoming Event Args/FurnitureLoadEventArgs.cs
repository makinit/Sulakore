...
{
    public class FurnitureLoadEventArgs : DataInterceptedEventArgs, IReadOnlyList<HFurniture>
    {
        ...
        public FurnitureLoadEventArgs(HMessage packet, int step, Func<Task> continuation)
